...
`,
			...
			(t.TokenSet = function () {
				...
				(t.TokenSet.fromClause = (e) => "editDistance" in e
						...
						for (var p = 0; p < d.length; p++) {
							...
							for (var T = 0; T < L.length; T++)
								for (
									...
									if (
										(i[g].upsert(O, l.boost, (Ue, Je) => Ue + Je),
										!s[q])
									) {
...
`),
	...
	function Ve(t, e, n) {
		...
		if (t.children) {
			...
			for (const l of t.children) Ve(l, c, i);
		} else De(t, r, t.class);
	}
	function De(t, e, n) {
		if (t.path) {
